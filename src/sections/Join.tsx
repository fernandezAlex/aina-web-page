			...
			<div className="relative mx-auto max-w-7xl px-6 md:px-12">
				<div ref={animatedRef} className="flex flex-col gap-6">
					...
					<div className="join-fade-item flex flex-col justify-center pt-2 lg:pr-6">
						...
						<h2 className="mt-3 text-[3.6rem] font-serif font-bold leading-[0.92] tracking-tight text-primary md:text-[5.2rem] xl:text-[6.2rem]">
							{join.title}
						</h2>
					...
					<article className="join-fade-item rounded-[2rem] border border-[#efd7c2] bg-[linear-gradient(180deg,rgba(255,236,208,0.78)_0%,rgba(255,225,185,0.7)_100%)] p-4 shadow-[0_20px_50px_rgba(138,80,31,0.08)] md:rounded-[2.5rem] md:p-8 xl:p-10">
