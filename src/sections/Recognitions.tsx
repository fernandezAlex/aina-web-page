...
const recognitionAwards: RecognitionAward[] = [
  ...
  },
  {
    ...
    year: '2024',
    imageSlot: 'FOTO JOAN MARIA MALAPEIRA',
    imageSrc: '',
  },
  {
    title: 'Reconocimiento Ayuntamiento de Hetauda',
    location: 'Nepal',
    year: '2023',
    imageSlot: 'FOTO AYUNTAMIENTO HT',
    imageSrc: '',
  },
  {
  ...
  },
  {
    ...
    location: 'Madrid',
    year: '2026',
    imageSlot: 'FOTO SOCIEDAD INCLUSIVA',
    imageSrc: '',
  },
];
    ...
    <section id="reconocimientos" className="relative w-full bg-forest-dark py-24 md:py-32 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-12">
        <div className="max-w-4xl mb-14 md:mb-20">
          ...
          <p className="mt-5 text-xl md:text-2xl font-serif italic text-white/80">
            Reconocimientos que impulsan la misión
          </p>
          <p className="mt-7 text-lg md:text-xl text-white/65 font-body leading-relaxed">
            Estos premios y reconocimientos refuerzan el compromiso de Si Asha Foundation con la educación,
            la inclusión y el acompañamiento a niños y jóvenes con discapacidad intelectual y del desarrollo.
            También recuerdan que cada avance institucional permite sostener y ampliar la misión en Nepal.
          </p>
        </div>
            ...
            >
              <div className="aspect-[4/3] rounded-lg border border-dashed border-white/20 bg-white/[0.04] overflow-hidden flex items-center justify-center">
                {award.imageSrc ? (
                  ...
                  <span className="px-6 text-center text-xs font-body uppercase tracking-[0.2em] text-white/45">
                    {award.imageSlot}
                  </span>
                )}
              </div>
              ...
              <div className="pt-6">
                <p className="text-sm font-body uppercase tracking-widest text-white/45">
