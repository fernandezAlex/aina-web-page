...
export function ImpactGalleryCard({
	...
	return (
		...
		>
			...
			>
				{hasImages && (
					<div className="relative min-h-[390px]  sm:min-h-[500px] xl:min-h-[800px] mb-10 pb-10">
						{mainImage && (
						...
						{lowerLeftImage && (
							<div className="lowerLeftImageContainer absolute bottom-[15%] left-[5%] z-20 aspect-square w-[58%] h-[35%] overflow-hidden rounded-full border-[8px] border-[#fffdf9] shadow-[0_18px_40px_rgba(73,32,24,0.18)]">
								<img
						...
						{lowerRightImage && (
							<div className="lowerRightImageContainer absolute bottom-[1%] right-[2%] z-10 aspect-square w-[54%] h-[35%] overflow-hidden rounded-full border-[8px] border-[#fffdf9] shadow-[0_18px_40px_rgba(73,32,24,0.16)]">
								<img
									src={lowerRightImage.src}
									alt={lowerRightImage.alt}
									className="h-full w-full object-cover object-[1%_center]"
									loading="lazy"
								/>
							</div>
						)}
