...
const contentByLocale: Record<Locale, LocalizedSiteContent> = {
	es: {
		...
		introMission: {
			...
			images: [
				{
					src: asset("/aina/intro/dscf1314.jpg"),
					alt: "Aina Barca abraza a una niña delante de un mural en Nepal",
				},
				{
				...
				{
					src: asset("/aina/intro/parte-de-arriba.jpg"),
					alt: "Aina Barca habla en una conferencia con micrófono",
				},
				{
		...
		vision: {
			...
			cards: [
				...
				},
				{
					...
					subtitle:
						"Cuando ayudas a personas que ayudan, el impacto se multiplica",
					description:
			...
			appearances: orderPressAppearances([
				{
					...
					category: "Radio",
					imageSrc: asset("/aina/press-media/radio-galega.png"),
				},
				{
					name: "National Gold",
					href: pressHref("National Gold"),
					category: "Televisión",
					imageSrc: asset("/aina/press-media/national-gold.png"),
				},
				{
					name: "RTVE",
					href: pressHref("RTVE"),
					category: "Televisión",
					imageSrc: asset("/aina/press-media/rtve.png"),
				},
				{
					name: "Radio Madrid SER",
					href: pressHref("Radio Madrid SER"),
					category: "Radio",
					imageSrc: asset("/aina/press-media/radio-madrid-ser.png"),
				},
				{
					name: "News24",
					href: pressHref("News24"),
					category: "Digital",
					imageSrc: asset("/aina/press-media/news24.png"),
				},
				{
					name: "RAC1",
					href: pressHref("RAC1"),
					category: "Radio",
					imageSrc: asset("/aina/press-media/rac1.png"),
				},
				{
					name: "Regió7",
					href: pressHref("Regio7"),
					category: "Prensa escrita",
					imageSrc: asset("/aina/press-media/regio7.png"),
				},
				{
					name: "TV3",
					href: pressHref("TV3"),
					category: "Televisión",
					imageSrc: asset("/aina/press-media/tv3.png"),
				},
				{
					name: "Radio Irun SER",
					href: pressHref("Radio Irun SER"),
					category: "Radio",
					imageSrc: asset("/aina/press-media/radio-irun-ser.png"),
				},
				{
					name: "Nepal Television",
					href: pressHref("Nepal Television"),
					category: "Televisión",
					imageSrc: asset("/aina/press-media/nepal-television.png"),
				},
				{
					name: "Mujer Emprendedora",
					href: pressHref("Mujer Emprendedora"),
					category: "Digital",
					imageSrc: asset("/aina/press-media/mujer-emprendedora.png"),
				},
				{
					name: "EITB",
					href: pressHref("EITB"),
					category: "Televisión",
					imageSrc: asset("/aina/press-media/eitb.png"),
				},
				{
					name: "RNE",
					href: pressHref("RNE"),
					category: "Radio",
					imageSrc: asset("/aina/press-media/rne.png"),
				},
				{
					name: "Mundo Solidario",
					href: pressHref("Mundo Solidario"),
					category: "Prensa solidaria",
					imageSrc: asset("/aina/press-media/mundo-solidario.png"),
				},
				{
					name: "Team TV",
					href: pressHref("Team TV"),
					category: "Televisión",
					imageSrc: asset("/aina/press-media/team-tv.png"),
				},
				{
					name: "El Confidencial",
					href: pressHref("El Confidencial"),
					category: "Digital",
					imageSrc: asset("/aina/press-media/el-confidencial.png"),
				},
				{
				...
				},
				{
					...
					category: "Radio",
					imageSrc: asset("/aina/press-media/ser-catalunya.png"),
				},
				{
					name: "Ratopati",
					href: pressHref("Ratopati"),
					category: "Digital",
					imageSrc: asset("/aina/press-media/ratopati.png"),
				},
				{
					name: "Ara",
					href: pressHref("Ara"),
					category: "Prensa escrita",
					imageSrc: asset("/aina/press-media/ara.png"),
				},
				{
					name: "La Vanguardia",
					href: pressHref("La Vanguardia"),
					category: "Prensa escrita",
					imageSrc: asset("/aina/press-media/la-vanguardia.png"),
				},
				{
					name: "Todo Literatura",
					href: pressHref("Todo Literatura"),
					category: "Cultura",
					imageSrc: asset("/aina/press-media/todo-literatura.png"),
				},
				{
					name: "Eco Diario",
					href: pressHref("Eco Diario"),
					category: "Digital",
					imageSrc: asset("/aina/press-media/eco-diario.png"),
				},
				{
					name: "Online Khabar",
					href: pressHref("Online Khabar"),
					category: "Digital",
					imageSrc: asset("/aina/press-media/online-khabar.png"),
				},
				{
					name: "RPP",
					href: pressHref("RPP"),
					category: "Radio / digital",
					imageSrc: asset("/aina/press-media/rpp.png"),
				},
				{
					name: "UOC",
					href: pressHref("UOC"),
					category: "Académico",
					imageSrc: asset("/aina/press-media/uoc.png"),
				},
				{
					name: "Onda Cero",
					href: pressHref("Onda Cero"),
					category: "Radio",
	...
	en: {
		...
		introMission: {
			...
			images: [
				{
					src: asset("/aina/intro/dscf1314.jpg"),
					alt: "Aina Barca hugging a girl in front of a mural in Nepal",
				},
				{
					src: asset("/aina/intro/aina-book.jpg"),
					alt: "Aina Barca smiling beside a child at school",
				},
				{
					src: asset("/aina/intro/aina-orange-shirt-child.jpg"),
					alt: "Aina Barca sitting outdoors and writing in a notebook",
				},
				{
					src: asset("/aina/intro/parte-de-arriba.jpg"),
					alt: "Aina Barca speaking at a conference with a microphone",
				},
				{
					src: asset("/aina/intro/aina-black-background.jpg"),
					alt: "Aina Barca with two children at school",
				},
			],
		},
		aboutAina: {
			subtitle: "About Aina",
			title:
				"Some journeys change one life. Some decisions end up changing many.",
			intro:
			...
			impactStats: [
				{
					value: 157,
					prefix: "+",
					label: "children with intellectual disabilities enrolled in school",
					useGrouping: true,
				},
				{
					value: 60,
					prefix: "+",
					label: "women are part of the professional team",
					useGrouping: true,
				},
				{
					value: 1000,
					prefix: "+",
					label: "families have found support, community, and hope",
					useGrouping: true,
				},
			],
			gallery: [
				{
					src: asset("/aina/about/aina-with-girl.jpg"),
					alt: "Aina Barca sharing a close moment with a girl",
				},
				{
					src: asset("/aina/about/aina-child-closeup.jpg"),
					alt: "Aina Barca smiling beside a child in Nepal",
				},
				{
					src: asset("/aina/about/aina-temple-selfie.jpg"),
					alt: "Self-portrait of Aina Barca with a Nepalese temple in the background",
				},
			],
		},
		vision: {
		...
		books: {
			...
			galleryImages: [
				{
					src: asset("/aina/main/aina-book-portrait-1.jpg"),
					alt: "Aina Barca in an editorial portrait linked to her work as an author",
				},
				{
					src: asset("/aina/main/aina-book-portrait-2.jpg"),
					alt: "Aina Barca writing and reviewing material in a work setting",
				},
			],
			showcaseImages: [
				{
					src: asset("/aina/book-cover-apple.jpg"),
					alt: "Cover of the book Asha, o la fuerza de la esperanza by Aina Barca",
				},
				{
					src: asset("/aina/book-cover-article.jpg"),
					alt: "Editorial image of the book Asha, o la fuerza de la esperanza published in cultural press",
				},
			],
		},
		press: {
		...
		join: {
			...
			gallery: [
				{
					src: asset("/aina/join/join-gallery-1.jpg"),
					alt: "Aina holding a girl in a yellow shirt in Nepal",
				},
				{
					src: asset("/aina/join/join-gallery-2.jpg"),
					alt: "Aina supporting a child outside a school in Nepal",
				},
				{
					src: asset("/aina/main/aina-child-floor-portrait.jpg"),
					alt: "Aina on the floor beside a child during an activity",
				},
				{
					src: asset("/aina/main/aina-child-embrace.jpg"),
					alt: "Aina and a child hugging in a moment of closeness",
				},
			],
			blocks: [
				{
	...
	ca: {
		...
		introMission: {
			...
			images: [
				{
					src: asset("/aina/intro/dscf1314.jpg"),
					alt: "L'Aina Barca abraça una nena davant d'un mural al Nepal",
				},
				{
					src: asset("/aina/intro/aina-book.jpg"),
					alt: "Aina Barca somriu al costat d'un infant a l'escola",
				},
				{
					src: asset("/aina/intro/aina-orange-shirt-child.jpg"),
					alt: "Aina Barca asseguda a l'aire lliure escrivint en una llibreta",
				},
				{
					src: asset("/aina/intro/parte-de-arriba.jpg"),
					alt: "L'Aina Barca parla en una conferència amb micròfon",
				},
				{
					src: asset("/aina/intro/aina-black-background.jpg"),
					alt: "Aina Barca acompanyada de dos infants a l'escola",
				},
			],
		},
		aboutAina: {
			...
			title:
				"Hi ha viatges que canvien una vida. I decisions que n'acaben canviant moltes altres.",
			intro:
			...
			impactStats: [
				{
					value: 157,
					prefix: "+",
					label: "infants amb discapacitat escolaritzats",
					useGrouping: true,
				},
				{
					value: 60,
					prefix: "+",
					label: "dones formen part de l'equip professional",
					useGrouping: true,
				},
				{
					value: 1000,
					prefix: "+",
					label: "famílies han trobat suport, comunitat i esperança",
					useGrouping: true,
				},
			],
			gallery: [
				{
					src: asset("/aina/about/aina-with-girl.jpg"),
					alt: "Aina Barca comparteix un moment proper amb una nena",
				},
				{
					src: asset("/aina/about/aina-child-closeup.jpg"),
					alt: "Aina Barca somriu al costat d'un infant al Nepal",
				},
				{
					src: asset("/aina/about/aina-temple-selfie.jpg"),
					alt: "Autoretrat d'Aina Barca amb un temple del Nepal al fons",
				},
			],
		},
		vision: {
		...
		books: {
			...
			galleryImages: [
				{
					src: asset("/aina/main/aina-book-portrait-1.jpg"),
					alt: "Aina Barca en un retrat editorial vinculat a la seva faceta com a autora",
				},
				{
					src: asset("/aina/main/aina-book-portrait-2.jpg"),
					alt: "Aina Barca escrivint i revisant material en un entorn de treball",
				},
			],
			showcaseImages: [
				{
					src: asset("/aina/book-cover-apple.jpg"),
					alt: "Portada del llibre Asha, o la fuerza de la esperanza d'Aina Barca",
				},
				{
					src: asset("/aina/book-cover-article.jpg"),
					alt: "Imatge editorial del llibre Asha, o la fuerza de la esperanza publicada en premsa cultural",
				},
			],
		},
		press: {
		...
		join: {
			...
			gallery: [
				{
					src: asset("/aina/join/join-gallery-1.jpg"),
					alt: "Aina sosté una nena amb samarreta groga al Nepal",
				},
				{
					src: asset("/aina/join/join-gallery-2.jpg"),
					alt: "Aina acompanya un infant davant d'una escola al Nepal",
				},
				{
					src: asset("/aina/main/aina-child-floor-portrait.jpg"),
					alt: "Aina a terra al costat d'un infant durant una activitat",
				},
				{
					src: asset("/aina/main/aina-child-embrace.jpg"),
					alt: "Aina i un infant s'abracen en un moment de complicitat",
				},
			],
			blocks: [
				{
