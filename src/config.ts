...
const contentByLocale: Record<Locale, LocalizedSiteContent> = {
  ...
  en: {
    ...
    press: {
      ...
      appearances: [
        ...
        { name: 'News24', category: 'Digital', imageSrc: asset('/aina/press-media/news24.png') },
        { name: 'RAC1', category: 'Radio', imageSrc: asset('/aina/press-media/rac1.png') },
        { name: 'Regio7', category: 'Print press', imageSrc: asset('/aina/press-media/regio7.png') },
        { name: 'TV3', category: 'Television', imageSrc: asset('/aina/press-media/tv3.png') },
        { name: 'Radio Irun SER', category: 'Radio', imageSrc: asset('/aina/press-media/radio-irun-ser.png') },
        { name: 'Nepal Television', category: 'Television', imageSrc: asset('/aina/press-media/nepal-television.png') },
        { name: 'Mujer Emprendedora', category: 'Digital', imageSrc: asset('/aina/press-media/mujer-emprendedora.png') },
        { name: 'EITB', category: 'Television', imageSrc: asset('/aina/press-media/eitb.png') },
        { name: 'RNE', category: 'Radio', imageSrc: asset('/aina/press-media/rne.png') },
        { name: 'Mundo Solidario', category: 'Solidarity press', imageSrc: asset('/aina/press-media/mundo-solidario.png') },
        { name: 'Team TV', category: 'Television', imageSrc: asset('/aina/press-media/team-tv.png') },
        { name: 'El Confidencial', category: 'Digital', imageSrc: asset('/aina/press-media/el-confidencial.png') },
        { name: 'El Diario Vasco', category: 'Print press', imageSrc: asset('/aina/press-media/el-diario-vasco.png') },
        { name: 'Confidenciales', category: 'Magazine / cover', imageSrc: asset('/aina/press-media/confidenciales-cover.png') },
        { name: 'SER Catalunya', category: 'Radio', imageSrc: asset('/aina/press-media/ser-catalunya.png') },
        { name: 'Ratopati', category: 'Digital', imageSrc: asset('/aina/press-media/ratopati.png') },
        { name: 'Ara', category: 'Print press', imageSrc: asset('/aina/press-media/ara.png') },
        { name: 'La Vanguardia', category: 'Print press', imageSrc: asset('/aina/press-media/la-vanguardia.png') },
        { name: 'Todo Literatura', category: 'Culture', imageSrc: asset('/aina/press-media/todo-literatura.png') },
        { name: 'Eco Diario', category: 'Digital', imageSrc: asset('/aina/press-media/eco-diario.png') },
        { name: 'Online Khabar', category: 'Digital', imageSrc: asset('/aina/press-media/online-khabar.png') },
        { name: 'RPP', category: 'Radio / digital', imageSrc: asset('/aina/press-media/rpp.png') },
        { name: 'UOC', category: 'Academic', imageSrc: asset('/aina/press-media/uoc.png') },
        { name: 'Onda Cero', category: 'Radio', imageSrc: asset('/aina/press-media/onda-cero.png') },
      ],
    },
    recognitions: {
  ...
  ca: {
    ...
    press: {
      ...
      appearances: [
        { name: 'Radio Galega', category: 'Radio', imageSrc: asset('/aina/press-media/radio-galega.png') },
        { name: 'National Gold', category: 'Televisio', imageSrc: asset('/aina/press-media/national-gold.png') },
        { name: 'RTVE', category: 'Televisio', imageSrc: asset('/aina/press-media/rtve.png') },
        { name: 'Radio Madrid SER', category: 'Radio', imageSrc: asset('/aina/press-media/radio-madrid-ser.png') },
        { name: 'News24', category: 'Digital', imageSrc: asset('/aina/press-media/news24.png') },
        { name: 'RAC1', category: 'Radio', imageSrc: asset('/aina/press-media/rac1.png') },
        { name: 'Regio7', category: 'Premsa escrita', imageSrc: asset('/aina/press-media/regio7.png') },
        { name: 'TV3', category: 'Televisio', imageSrc: asset('/aina/press-media/tv3.png') },
        { name: 'Radio Irun SER', category: 'Radio', imageSrc: asset('/aina/press-media/radio-irun-ser.png') },
        { name: 'Nepal Television', category: 'Televisio', imageSrc: asset('/aina/press-media/nepal-television.png') },
        { name: 'Mujer Emprendedora', category: 'Digital', imageSrc: asset('/aina/press-media/mujer-emprendedora.png') },
        { name: 'EITB', category: 'Televisio', imageSrc: asset('/aina/press-media/eitb.png') },
        { name: 'RNE', category: 'Radio', imageSrc: asset('/aina/press-media/rne.png') },
        { name: 'Mundo Solidario', category: 'Premsa solidaria', imageSrc: asset('/aina/press-media/mundo-solidario.png') },
        { name: 'Team TV', category: 'Televisio', imageSrc: asset('/aina/press-media/team-tv.png') },
        { name: 'El Confidencial', category: 'Digital', imageSrc: asset('/aina/press-media/el-confidencial.png') },
        { name: 'El Diario Vasco', category: 'Premsa escrita', imageSrc: asset('/aina/press-media/el-diario-vasco.png') },
        { name: 'Confidenciales', category: 'Revista / portada', imageSrc: asset('/aina/press-media/confidenciales-cover.png') },
        { name: 'SER Catalunya', category: 'Radio', imageSrc: asset('/aina/press-media/ser-catalunya.png') },
        { name: 'Ratopati', category: 'Digital', imageSrc: asset('/aina/press-media/ratopati.png') },
        { name: 'Ara', category: 'Premsa escrita', imageSrc: asset('/aina/press-media/ara.png') },
        { name: 'La Vanguardia', category: 'Premsa escrita', imageSrc: asset('/aina/press-media/la-vanguardia.png') },
        { name: 'Todo Literatura', category: 'Cultura', imageSrc: asset('/aina/press-media/todo-literatura.png') },
        { name: 'Eco Diario', category: 'Digital', imageSrc: asset('/aina/press-media/eco-diario.png') },
        { name: 'Online Khabar', category: 'Digital', imageSrc: asset('/aina/press-media/online-khabar.png') },
        { name: 'RPP', category: 'Radio / digital', imageSrc: asset('/aina/press-media/rpp.png') },
